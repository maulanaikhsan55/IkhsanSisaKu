...
<div class="w-full min-h-screen px-3 sm:px-4 md:px-6 lg:px-12 py-4 sm:py-6 md:py-8">
        ...
        <div class="mb-6 sm:mb-8 animate-fade-in-up">
            <div class="min-w-0 flex-1">
                <h1 class="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-1 leading-tight">Pengaturan Akun</h1>
                <p class="text-xs sm:text-sm text-gray-500 font-medium">Kelola profil dan keamanan akun Anda</p>
            </div>
        </div>

        <!-- Success Message -->
        @if(session('success'))
        <div class="mb-4 sm:mb-6 bg-green-100 border-l-4 border-green-500 text-green-700 px-3 sm:px-6 py-3 sm:py-4 rounded-lg sm:rounded-xl text-xs sm:text-sm animate-fade-in-up">
        ...
        <!-- Error Messages -->
        @if($errors->any())
        <div class="mb-4 sm:mb-6 bg-red-100 border-l-4 border-red-500 text-red-700 px-3 sm:px-6 py-3 sm:py-4 rounded-lg sm:rounded-xl animate-fade-in-up">
