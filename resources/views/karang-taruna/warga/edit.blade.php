    ...
    <div class="max-w-3xl mx-auto py-6">
        ...
        <div class="mb-8 animate-fade-in-up">
            <div class="flex items-center gap-3">
                <a href="{{ route('karang-taruna.warga.show', $warga) }}" class="p-2 md:p-3 hover:bg-white/50 rounded-lg md:rounded-xl transition-colors flex-shrink-0">
                    <i class="fas fa-arrow-left text-gray-600 text-lg md:text-xl"></i>
                </a>
                <div class="min-w-0">
                    <h1 class="text-3xl md:text-4xl font-bold text-gray-900">Edit Warga</h1>
                    <p class="text-gray-600 mt-1 text-sm md:text-base">Ubah data warga {{ $warga->nama }}</p>
                </div>
            </div>
        </div>
