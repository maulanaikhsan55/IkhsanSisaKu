...
<body>
    ...
    <div class="summary">
        <div class="summary-item">
            ...
            <span class="summary-value">{{ number_format($totalBerat, 2, ',', '.') }} kg</span>
        </div>
        <div class="summary-item">
    ...
    <div class="title">Rincian Per Kategori Sampah</div>
    <table>
        <thead>
            <tr>
                <th>No</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $item['kategori'] }}</td>
                <td style="text-align: right;">{{ number_format($item['total_berat'], 2, ',', '.') }}</td>
                <td style="text-align: right;">{{ number_format($item['total_co2'], 2, ',', '.') }}</td>
                <td style="text-align: right;">{{ $totalBerat > 0 ? number_format(($item['total_berat'] / $totalBerat) * 100, 2, ',', '.') : 0 }}%</td>
