        ...
        <div class="mb-6 sm:mb-8 animate-page-load">
            <div class="flex items-center gap-3 sm:gap-4">
                ...
                <div class="min-w-0 flex-1">
                    <h1 class="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 leading-tight">Tambah Transaksi Kas</h1>
                    <p class="text-gray-600 mt-1 text-xs sm:text-sm">Catat transaksi kas masuk atau keluar</p>
                </div>
            </div>
        </div>
