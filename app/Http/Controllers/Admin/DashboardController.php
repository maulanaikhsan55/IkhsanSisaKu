...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $totalSampahKg = DB::table('transaksi_sampah_items')->sum('berat_kg');
        $totalCO2 = DB::table('transaksi_sampah_items')->sum('co2_tersimpan');
        ...
        // Get pie chart data from items (for multi-item transactions) and header (for single-item)
        ...
        // Get top performer karang taruna - from items table for accuracy
